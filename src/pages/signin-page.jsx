          ...
          <div className="max-w-md w-full border py-8 px-6 rounded border-gray-300 bg-white">
            <form onSubmit={handleSubmit}>
              ...
              <div className="mt-8">
                ...
                <div className="relative flex items-center">
                  <input autoComplete="off" name="password" type={showPassword ?'text' : 'password'} required className="w-full text-sm border-b border-gray-300 focus:border-[#333] px-2 py-3 outline-none" placeholder="Enter password" />
                  <i className={`fa-solid fa-eye${showPassword ? '-slash' : ''} w-[18px] h-[18px] absolute right-2 cursor-pointer`} onClick={togglePasswordVisibility}></i>
                </div>
              </div>
              {error && <p className=" text-red-700 px-2 py-2 rounded relative mt-2" role="alert">{error}</p>}

              <div className="flex items-center justify-between gap-2 mt-5">
                <div className="flex items-center">
                  <input id="remember-me" name="remember-me" type="checkbox" className="h-4 w-4 shrink-0 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" onChange={(e) => setRememberMe(e.target.checked)} />
              ...
              <div className="space-x-8 flex justify-center">
                ...
                <button onClick={signInWithGoogle} type="button" className="border-none outline-none">
                  ...
                  <path fill="#fbbd00"
                    ...
                    <path fill="#31aa52"
                      d="M139.131 325.477-86.308 411.785a260.085 260.085 0 0 0 22.158 25.235C123.333 485.371 187.62 512 256 512V392c-49.624 0-93.117-26.72-116.869-66.523z"
